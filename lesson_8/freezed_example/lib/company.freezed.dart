...
abstract class $CompanyCopyWith<$Res> {
  ...
  $Res call({String name, String? director, List<Location> locations});
}
...
class _$_Company implements _Company {
  ...
  @override
  String toString() {
    return 'Company(name: $name, director: $director, locations: $locations)';
  }
...
abstract class _Company implements Company {
  const factory _Company(
      ...
      final String? director,
      required final List<Location> locations}) = _$_Company;
