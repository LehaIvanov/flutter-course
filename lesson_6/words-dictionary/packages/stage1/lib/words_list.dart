...
import 'package:stage1/data/word.dart';
import 'package:stage1/data/words_service.dart';
import 'package:stage1/language_filters_provider.dart';
import 'package:stage1/style.dart';
...
class _NativeLanguageWord extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text(
      word.translations[LanguageFiltersProvider.of(context).wordLanguage] ?? '',
...
class _StudiedLanguageWord extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text(
      word.translations[
              LanguageFiltersProvider.of(context).translationLanguage] ??
          '',
      style: const TextStyle(fontSize: fontSize),
    );
  }
